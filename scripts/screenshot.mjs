...
const GAMES = ['bubbles', 'aquarium', 'shapes', 'colors', 'sizes', 'shadows', 'piano', 'paint', 'peekaboo', 'feed', 'wash', 'count', 'memory', 'xylo', 'drums', 'band', 'simon', 'jigsaw', 'blocks', 'pattern', 'orchestra', 'bricks', 'birthday', 'cooking', 'teeth', 'jam'];
const VIEWPORTS = [
