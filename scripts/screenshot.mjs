...
const GAMES = ['bubbles', 'aquarium', 'garden', 'farm', 'drive', 'shapes', 'colors', 'sizes', 'shadows', 'sounds', 'piano', 'paint', 'peekaboo', 'feed', 'wash', 'count', 'memory', 'xylo', 'drums', 'band', 'simon', 'jigsaw', 'blocks', 'pattern', 'orchestra', 'bricks', 'birthday', 'cooking', 'teeth', 'bedtime', 'jam'];
const VIEWPORTS = [
