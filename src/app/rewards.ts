...
export const STICKERS: readonly Sticker[] = [
  { emoji: '🐻', name: 'gấu nâu' }, { emoji: '🦊', name: 'cáo' }, { emoji: '🐼', name: 'gấu trúc' }, { emoji: '🦁', name: 'sư tử' },
  { emoji: '🐯', name: 'hổ' }, { emoji: '🐨', name: 'koala' }, { emoji: '🐸', name: 'ếch' }, { emoji: '🐙', name: 'bạch tuộc' },
  { emoji: '🦄', name: 'kỳ lân' }, { emoji: '🐬', name: 'cá heo' }, { emoji: '🦋', name: 'bướm' }, { emoji: '🐞', name: 'bọ rùa' },
  { emoji: '🦖', name: 'khủng long' }, { emoji: '🐳', name: 'cá voi' }, { emoji: '🦜', name: 'vẹt' }, { emoji: '🦩', name: 'hồng hạc' },
  { emoji: '🌈', name: 'cầu vồng' }, { emoji: '⭐', name: 'ngôi sao' }, { emoji: '🌙', name: 'mặt trăng' }, { emoji: '☀️', name: 'mặt trời' },
  { emoji: '🌸', name: 'hoa anh đào' }, { emoji: '🌻', name: 'hoa hướng dương' }, { emoji: '🍄', name: 'nấm' }, { emoji: '🌵', name: 'xương rồng' },
  { emoji: '🚀', name: 'tên lửa' }, { emoji: '🚂', name: 'tàu hoả' }, { emoji: '🚁', name: 'trực thăng' }, { emoji: '⛵', name: 'thuyền buồm' },
  { emoji: '🎈', name: 'bóng bay' }, { emoji: '🎁', name: 'hộp quà' }, { emoji: '🎪', name: 'rạp xiếc' }, { emoji: '🎠', name: 'ngựa gỗ' },
  { emoji: '🍦', name: 'kem' }, { emoji: '🍩', name: 'bánh vòng' }, { emoji: '🍭', name: 'kẹo mút' }, { emoji: '🎂', name: 'bánh sinh nhật' },
  { emoji: '🏰', name: 'lâu đài' }, { emoji: '🎸', name: 'đàn ghi-ta' }, { emoji: '🥁', name: 'trống' }, { emoji: '🎨', name: 'bảng màu' },
  { emoji: '🐥', name: 'gà con' }, { emoji: '🐰', name: 'thỏ' }, { emoji: '🐧', name: 'chim cánh cụt' }, { emoji: '🦕', name: 'khủng long cổ dài' },
  { emoji: '👑', name: 'vương miện' }, { emoji: '🏆', name: 'cúp' }, { emoji: '🎯', name: 'bia' }, { emoji: '💎', name: 'kim cương' },
];
