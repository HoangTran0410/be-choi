...
export const SPECIES: readonly Species[] = [
  { id: 'chicken', name: 'con gà', voice: 'chirp', coat: '#fef3c7', spot: '#ef4444', size: 0.5, speed: 1.5, legs: 2, gait: 'peck', lays: true, swims: false },
  { id: 'duck', name: 'con vịt', voice: 'quack', coat: '#fafaf9', spot: '#f59e0b', size: 0.55, speed: 1.2, legs: 2, gait: 'walk', lays: false, swims: true },
  { id: 'cow', name: 'con bò', voice: 'moo', coat: '#fafaf9', spot: '#44403c', size: 1.35, speed: 0.7, legs: 4, gait: 'walk', lays: false, swims: false },
  { id: 'pig', name: 'con heo', voice: 'pig', coat: '#f9a8d4', spot: '#f472b6', size: 1, speed: 0.9, legs: 4, gait: 'walk', lays: false, swims: false },
  { id: 'sheep', name: 'con cừu', voice: 'sheep', coat: '#f8fafc', spot: '#4b5563', size: 0.9, speed: 0.8, legs: 4, gait: 'walk', lays: false, swims: false },
  { id: 'horse', name: 'con ngựa', voice: 'kazoo', coat: '#b45309', spot: '#78350f', size: 1.4, speed: 1.4, legs: 4, gait: 'walk', lays: false, swims: false },
  { id: 'rabbit', name: 'con thỏ', voice: 'sparkle', coat: '#e7e5e4', spot: '#fbcfe8', size: 0.55, speed: 1.6, legs: 4, gait: 'hop', lays: false, swims: false },
  { id: 'goat', name: 'con dê', voice: 'sheep', coat: '#d6d3d1', spot: '#57534e', size: 0.85, speed: 1, legs: 4, gait: 'walk', lays: false, swims: false },
];
 ...
 */
export function stepAnimal(animal: Animal, dt: number, yard: Yard, grains: readonly Grain[], rng: () => number = Math.random): Grain | null {
